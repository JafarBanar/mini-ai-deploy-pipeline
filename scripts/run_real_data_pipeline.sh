...
python src/benchmark.py --backend "$BACKEND" --model artifacts/model.onnx --mode "$BENCH_MODE" --device "$DEVICE" --precision "$PRECISION" --out artifacts/bench.json --warmup 50 --iters 500 --telemetry-jsonl artifacts/telemetry/real.jsonl
