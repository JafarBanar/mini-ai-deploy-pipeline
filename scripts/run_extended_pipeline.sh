...
python src/benchmark.py --backend "$BACKEND" --model artifacts/model.onnx --out artifacts/bench.json --warmup 50 --iters 500 --telemetry-jsonl artifacts/telemetry_extended.jsonl
